//
//  HorizontalRoundedGradientView.swift
//
...
@IBDesignable
class HorizontalRoundedGradientView: RoundUIView {
    ...
    private func setGradient() {
        ...
        if let leftGradientColor = leftGradientColor, let rightGradientColor = rightGradientColor {
            ...
            let path = UIBezierPath(roundedRect: rect, byRoundingCorners:[  .bottomLeft, .bottomRight, .topLeft, .topRight], cornerRadii: CGSize(width: cornerRadius2, height: cornerRadius2))
